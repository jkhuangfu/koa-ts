...
declare global {
  ...
  export class DB {
     ...
     */
    public static handle(sql: string, query: any[]): Promise<{ code: number; msg?: MysqlError | string; result?: any }>;
  }
  ...
  export class redisDb {
    ...
    public static del(keys: string | string[]): Promise<boolean>;
  }
  ...
  export class JWT {
     ...
     */
    public static generate(value: string | object | Buffer, secret?: string, expires?: string): Promise<string | boolean>;
    /**
     ...
     */
    public static verify(token: string, secret?: string): Promise<object | string | boolean>;
  }

  export function getParams(ctx: Koa.Context): { [key: string]: any };
